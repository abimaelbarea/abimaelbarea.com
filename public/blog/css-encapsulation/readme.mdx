...
subtitle: What is CSS Encapsulation and why is it so important?
description: An introduction to CSS Encapsulation
date: "2022-05-09"
headline: /blog/css-encapsulation/main.svg
ogImage: /blog/css-encapsulation/og.png
...
As a front-end developer or a person that intends to create any kind of website or web application, you're are going to end up dealing with CSS. There're some important concepts around the language that need to be understood to make your life easier while you're writing it.
...
> Stylesheets cascade — at a very simple level, this means that the order of CSS rules matters; when two rules are applied and have equal specificity, the one that comes last in the CSS is the one that will be used. [CSS Building Blocks, MDN](https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Cascade_and_inheritance#the_cascade)

### How is CSS applied?

To understand this process let's take a look at this image from [CSS First Steps, MDN](https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps/How_CSS_works#how_does_css_actually_work):

![Rendering Process](/blog/css-encapsulation/rendering.svg)
...
Since the beginning of the web, developers have been looking for solutions to this, some of them are pretty popular like [BEM](http://getbem.com/). But let's continue with CSS Encapsulation and some definitions are:
...
<div className="callout --info">
  **CSS Encapsulation** is focused on [DX - Developer
...
**Why do I mention this properties?** Well, because while using Web Components and ShadowDom for CSS encapsulation <u>you could still override your styles in case you need it</u> with the power of CSS variables.

<div className="callout --info">
  **CSS Variables**
  <u>
    are widely supported by browsers and could be used in combination with
    solutions
  </u>
